...
model_path = 'DRUNET_color_64_plain.pth'
n_channels = 3
...
# nb: default 9 for BSD68. Set nb=21 for single image
...
def search_args():
    ...
    ratio = 1.44
    ## peak =  100, CBSD68_cut, poisson noise removal task. 
    # kernel 1 
    search_range[0.12] = [2000,2100,2200,2300,2400] # ??.????, 0.????
    # kernel 2
    # search_range[0.12] = [2000,2100,2200,2300,2400] #  
    # kernel 3
    # search_range[0.12] = [2000,2100,2200,2300,2400] #  
    # kernel 4
    # search_range[0.12] = [2000,2100,2200,2300,2400] #  
    ...
    ## peak =  50, CBSD68_cut, poisson noise removal task. 
    # kernel 1 
    # search_range[0.12] = [700,800,900,1000,1100] # ??.????, 0.????
    # kernel 2
    # search_range[0.12] = [700,800,900,1000,1100] #  
    # kernel 3
    # search_range[0.12] = [700,800,900,1000,1100] #  
    # kernel 4
    # search_range[0.12] = [700,800,900,1000,1100] #  
    ...
    search_level = [0.12]# [5, 10, 15, 20, 25, 30]
...
# peak=50
# plot_psnr(0.12, 800, 50, 1.44) # 21.35

# max_psnr, max_level, max_lamb = search_args()

# 0001.png, kernel1, nb=21
# plot_psnr(0.12, 2000, 100, 1.44) # 25.33
# plot_psnr(0.12, 900, 50, 1.44) # 24.12

# 0005.png, kernel8, nb=21
# plot_psnr(0.12, 1200, 50, 1.44) # 23.65
# plot_psnr(0.12, 1000, 50, 1.0) # 25.13
plot_psnr(0.2, 3000, 50, 1.1) # 25.39

# butterfly.png, kernel3, nb=21
# plot_psnr(0.12, 1200, 50, 1.44) # 24.40

# butterfly.png, kernel2, nb=21
# plot_psnr(0.12, 1200, 50, 1.44) # 21.17
# plot_psnr(0.16, 1800, 50, 1.1) # 25.00
